...
if __name__ == "__main__":
    ...
    #hmc5883l=HMC5883L(bus, 0x1e, "compass", 3, 6, 1, 0, 769, -779, 78)
    #hmc5883l=HMC5883L(bus, 0x1e, "compass", 3, 6, 1, 0, 769, -779, -277) #calibrated for Z axis
    hmc5883l=HMC5883L(bus, 0x1e, "compass", 3, 6, 1, 0, -576, -832, 362)
    while True:
    	hmc5883l.read_raw_data()
    	print hmc5883l.read_scaled_x(), hmc5883l.read_scaled_y(), hmc5883l.read_scaled_z(), math.degrees(hmc5883l.read_bearing())
	time.sleep(0.1)
