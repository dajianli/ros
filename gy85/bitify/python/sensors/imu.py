...
class IMU(object):
    ...
    def __init__(self, bus, gyro_address, accel_address, compass_address, name, accel_scale=ADXL345.AFS_16g):
        self.bus = bus
        ...
        self.gyroscope = ITG3205(bus, gyro_address,  name + "-gyroscope") 
        self.compass = HMC5883L(bus, compass_address, name + "-compass", 3, 6)
